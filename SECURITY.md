...
1. **Submit Privately**: Navigate to the **Security** tab of this repository on GitHub, click **Report a vulnerability**, and fill out the form. Alternatively, email your findings to `grasp@psi.edu`.
